	  <div class="card">
	    ...
	    <div class="card-body">
			<nav class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
								  ...
								  <div class="modal-dialog modal-dialog-centered" role="document">
								    <div class="modal-content">
								      <div class="modal-header">
								        <h5 class="modal-title cinzel ls-3 text-warning" id="exampleModalLongTitle">Llamados en la madrugada</h5>
			  ...
			  <a class="nav-item nav-link btn btn-outline-primary disabled" href="#"><i class="fas fa-shopping-cart"></i> (próximamente)</a>
			</nav>
	    </div>
	  </div>
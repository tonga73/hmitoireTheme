...
<section id="libros-list" class="card-columns p-1">
	<!-- I -->
	  <div class="card">
	    <img class="card-img-top" src="http://hugomitoire.com/wp-content/uploads/2018/08/Terror-1.jpg" alt="Card image cap">
	    <div class="card-body">
			<nav class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
			  <!-- Button trigger modal -->
			  <a class="btn btn-warning" data-toggle="collapse" href="#collapse1Terror" role="button" aria-expanded="false" aria-controls="collapse1Terror">Índice</a>

				<div class="collapse" id="collapse1Terror">
	...
	<!-- V -->
	  <div class="card">
	    ...
	    <div class="card-body">
			<nav class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
			  <!-- Button trigger modal -->
			  <a class="btn btn-warning" data-toggle="collapse" href="#collapse5Terror" role="button" aria-expanded="false" aria-controls="collapse5Terror">Índice</a>

				<div class="collapse" id="collapse5Terror">
				  <div class="card card-body">
				    <ul>
				    	<li>
				    		<p>Mensajes del Más Allá 
				    	...
				    	<li>
				    		<p>
								<!-- Button trigger modal -->
				    			<a data-toggle="modal" data-target="#juegoCopaModal" href="#">
					    			El juego de la copa 
					    			<small id="leer">
					    		      <i class="fab fa-readme"></i>
					    		    </small>
								...
								<!-- Modal -->
								<div class="modal fade bd-example-modal-lg" id="juegoCopaModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
								  <div class="modal-dialog modal-dialog-centered" role="document">
								    <div class="modal-content">
								      <div class="modal-header">
								      ...
								      <div class="modal-body container belle h4">
										...
										<p class="font-weight-bold">AHORA ÉL ESTÁ AQUÍ.</p>
										<p class="p-2">
										...
										<p>
											Y en ese instante, un estruendo en la alacena los sacudió a todos. Era como si alguien se hubiera puesto a patear ollas, sartenes y cacerolas.
										</p>
										<p>
											ES ÉL —marcó la copa.
										</p>
										<p class="p-2">
											—¿Qué podemos hacer, prima? Decinos qué hacer...
										</p>
										<p>
											NADA —respondió.
										</p>
										<p class="p-2">
											—¡¿Cómo nada?! ¡Cristina, no seas mala!
										</p>
										<p>
											Y la copa se movió con rapidez formando las palabras: NADA PUEDE HACERSE CONTRA UN ALMA EN PENA.
										</p>
										<p>
											Todos ya transpiraban de miedo, temblaban como una hoja, y en el acto la copa reanudó su movimiento.
										</p>
										<p>
											VAS A MORIR, FEDERICO —marcó.
										</p>
										<p class="p-2">
											—¡Prima! ¡¿Por qué me decís eso?!
										</p>
										<p>
											TU PRIMA YA SE FUE. SOY RUBÉN —marcó la copa y se armó un batifondo de padre y señor nuestro. ¡Era el espíritu de Rubén el que ahora movía la copa! Federico se largó a llorar y las chicas empezaron a gritar y a abrazarse. En ese instante, se apagó la luz y el ambiente se transformó en un verdadero loquero. Todos gritaban, corrían, se chocaban y caían, buscando la salida o alguna luz.
										</p>
										<p>
											Las luces de la casa se encendieron por unos segundos, y todos se vieron los rostros de pánico y desesperación, pero antes de que reaccionaran o corrieran a abrazarse, de nuevo quedaron en la más absoluta oscuridad.
										</p>
										<p>
											En medio del griterío y ruidos de todo tipo, se escuchó un largo y lacerante alarido, como si estuvieran matando a alguien. En esa terrible situación, nadie podía orientarse de dónde venía el grito, ni de quién era. El alarido parecía retomar fuerza y volvía a escucharse con intensidad, para poco a poco ir perdiendo fuerza y transformarse en un lamento agónico. Hasta que finalmente ya no se escuchó.
										</p>
										<p>
											El pánico y la desesperación se habían apoderado de todos. Nadie gritaba, ni hablaba. Con el aliento contenido, escucharon esos terribles alaridos. Ninguno sabía dónde estaban los demás, salvo las dos chicas, que quedaron abrazadas y acurrucadas en un rincón del living.
										</p>
										<p>
											Se escuchó un gran portazo, que al parecer provenía de una de las piezas de arriba. Luego el ruido de alguien o algo que cae por las escaleras, pero ningún sonido humano.
										</p>
										<p class="p-2">
											—¡Chicos! ¿Dónde están?! —se escuchó gritar en medio de la oscuridad a María. 
										</p>
										<p class="p-2">
											—¡Yo estoy en el baño! —respondió Carlos.
										</p>
										<p class="p-2">
											—¡Felipe, hacé algo para que se vaya el espíritu! —gritó Sebastián.
										</p>
										<p>
											Nadie respondió.
										</p>
										<p class="p-2">
											-—¡Griten cada uno sus nombres y donde están! —volvió a exclamar María. 
										</p>
										<p class="p-2">
											—¡Carlos y estoy en el baño!
										</p>
										<p class="p-2">
											—¡Soy María y estoy con Zulma en el living!
										</p>
										<p class="p-2">
											—¡Sebastián y estoy debajo de la escalera!
										</p>
										<p>
											Federico y Felipe no respondían.
										</p>
										<p class="p-2">
											—¡Felipe! —gritó su hermano.
										</p>
										<p>
											Silencio.
										</p>
										<p class="p-2">
											—¡Federico! —gritó María.
										</p>
										<p class="p-2">
											Silencio.
										</p>
										<p>
											De pronto María comenzó a gritar con desesperación, al tiempo que se escuchaban ruidos de lucha y de objetos que caían en el living. También se oían alaridos, al parecer de Zulma.
										</p>
										<p class="p-2">
											—¡Alguien se lleva a Zulma! ¡Por favor, ayúdenme! —gritaba María.
										</p>
										<p>
											Y nadie sabía qué hacer, ni dónde ni cómo. Porque todo era oscuridad y caos. Ruidos y gritos.
										</p>
										<p>
											Luego de que cesaron esos ruidos mezclados, sólo se oía el llanto desconsolado de María, que poco a poco fue transformándose en gemidos cada vez más débiles. Después, nuevamente el silencio total.
										</p>
										<p>
											Ya nadie gritaba, ni llamaba ni intentaba hacer algo, tal vez por miedo a descubrir su posición.
										</p>
										<p>
											Nadie sabe cuánto tiempo pasó. Tal vez fueron diez o veinte minutos, o quizá dos o tres horas. El primero en incorporarse de su escondite fue Carlos y empezó a llamar a todos. Sebastián respondió enseguida y también salió de abajo de la escalera. No podían verse, pero se orientaban por las voces.
										</p>
										<p>
											Sebastián, tanteando a ciegas, buscó y encontró una linterna. Tomándose uno a otro, los dos comenzaron a buscar por toda la casa. Fueron hacia el living, y detrás de un sillón, encontraron acurrucada y temblando a María. No hablaba ni lloraba, sólo tiritaba. Sus ojos muy abiertos reflejaban el espanto.
										</p>
										<p>
											La levantaron, la abrazaron tratando de consolarla. Le hablaban, pero ella no respondía.
										</p>
										<p>
											Antes de continuar la búsqueda de los demás, prendieron unas velas en varias partes de la casa. A María la acostaron en un sofá y seguía temblando en silencio. Los dos muchachos, aterrados y confusos, se hacían de coraje para buscar a los que faltaban.
										</p>
										<p>
											Buscaron por toda la casa, y lo único que veían era desorden, objetos desparramados y rotos, como si por allí hubiera pasado un tornado. Algunas ventanas rotas, vidrios por todas partes, pero de los chicos… nada.
										</p>
										<p>
											No se animaron a salir. A la casa ya la habían recorrido varias veces, tanto en la planta superior como ahí abajo, y ni un rastro de Federico, Felipe y Zulma. Tampoco encontraron ninguna mancha de sangre, y eso los tranquilizó un poco.
										</p>
										<p>
											Debían decidir algo, porque los desesperaba estar ahí encerrados por el propio miedo y sin saber nada de sus amigos.
										</p>
										<p>
											Buscaron un reloj para al menos orientarse con la hora. Eran casi las cuatro. En esa noche sin luna, todos los alrededores de la casa estaban sumidos en la total oscuridad. Ni se les ocurría —ni se animaban—  ir hasta el pueblo en bici o a pie.
										</p>
										<p>
											Durante las casi dos horas que esperaron hasta que amaneciera, esos dos muchachos sintieron las más terribles emociones: por momentos, durante la búsqueda, miedo y espanto;  luego desesperación y angustia al no poder encontrar a sus amigos; y finalmente dolor y desconsuelo al pensar en lo peor. 
										</p>
										<p>
											Cuando la tenue claridad del amanecer comenzó a filtrarse por las ventanas, una mezcla de esperanza y miedo se apoderó de ellos. María seguía en el mismo estado. Querían salir a buscar, pero los paralizaba el miedo a encontrarse con algo terrible.
										</p>
										<p>
											Esperaron un rato más, y con los primeros rayos del sol, salieron de la casa. Buscaban los dos juntos, habían acordado no separarse.
										</p>
										<p>
											Lo que encontraron les cortó la respiración y no atinaron a hacer nada. Felipe se había trepado —o lo habían llevado hasta allí— a la torre metálica del tanque de agua. Estaba a unos siete u ocho metros de altura, enredado entre las varillas y la escalera de la estructura. Su cuerpo parecía... inerte.
										</p>
										<p>
											Los chicos empezaron a gritar su nombre, y el hermano comenzó a treparse con desesperación. Llegó hasta él.
										</p>
										<p class="p-2">
											—¡Está vivo! —gritaba Carlos al tiempo que sacudía a su hermano para que reaccionara.
										</p>
										<p class="p-2">
											—¡Felipe! ¡Felipe! ¡Contestame, soy tu hermano!
										</p>
										<p>
											Sebastián trató de tranquilizarlo, pidiendo que bajara, que podía hacerlo caer si lo seguía sacudiendo. Carlos bajó y le dijo a Sebastián que iría al pueblo a buscar ayuda. Agarró una bicicleta y salió a toda velocidad.
										</p>
										<p>
											Sebastián quedó solo y no se animó a seguir buscando a los otros. Entró en la casa y se sentó junto a María. Allí esperó.
										</p>
										<p>
											Antes de la media hora, ya llegaron dos vehículos de la policía y pocos minutos más tarde, comenzaron a llegar los padres y familiares de los chicos.
										</p>
										<p>
											Todo era conmoción y desesperación. Gritos de dolor y angustia. Ya sabían por Carlos lo que había ocurrido. Apenas llegaron, algunos ingresaron en la casa y sacaron a María para llevarla al Hospital. Entre varios policías y familiares se organizaron y bajaron a Felipe, que estaba vivo pero inconsciente, y también fue llevado al hospital. 
										</p>
										<p>
											Los demás se pusieron a recorrer todos los alrededores. A Zulma la encontraron dentro de un galpón, hasta donde con seguridad fue arrastrada, ya que se veía claramente el sendero en la tierra de un cuerpo arrastrado. La huella comenzaba en la casa y terminaba ahí, dentro del galpón. La chica estaba hecha un ovillo entre unas bolsas de algodón. Una posición que adquieren las personas sometidas a un terrible espanto, a algo aterrador y mortal. La expresión de su rostro confirmaba eso. Tenía los ojos bien abiertos, con las facciones del rostro deformadas por el espanto. 
										</p>
										<p>
											Federico seguía sin aparecer. 
										</p>
										<p>
											Luego de revisar una y otra vez toda la casa y dependencias, se pusieron a recorrer el campo y las chacras de los alrededores. Todo el mundo buscaba con desesperación a Federico. Entre policías, familiares, vecinos y curiosos, ya eran más de cincuenta en la búsqueda.
										</p>
										<p>
											A orillas del arroyito encontraron un pedazo de tela. Sebastián confirmó que ése era el color de la camisa que esa noche tenía Federico. El arroyo no tenía mucha profundidad, apenas alcanzaba el metro en la parte más honda. Siguieron buscando por las orillas, y a unos cien metros de ese primer rastro, lo encontraron.
										</p>
										<p>
											El cuerpo de Federico estaba boca abajo en el arroyo y lo llevaba los brazos extendidos. 
										</p>
										<p>
											Más tarde, en la comisaría, los dos muchachos —Carlos y Sebastián— contaron detalles del juego y cómo había empezado toda esa terrible situación. Nadie creía que todo lo acontecido pudiera haber sido obra de algún espíritu. No encontraban una explicación a nada, menos aún a que Federico hubiera muerto ahogado en ese lugar, donde la profundidad no era mayor a los cuarenta o cincuenta centímetros.
										</p>
										<p>
											Lo más increíble fue que luego de los estudios y análisis que le hicieron al cadáver, no se encontró ningún signo de lucha o agresión. No tenía marcas de haber sido estrangulado o golpeado. Después de buscar y revolver toda la casa y sus alrededores, después de rastrillar toda la zona, buscando huellas o pistas algún posible asesino, no se encontró absolutamente nada.
										</p>
										<p>
											Nadie pudo explicarse cómo esos tres chicos pudieron haber sido llevados hasta donde fueron hallados. 
										</p>
										<p>
											María abandonó ese año el colegio y se sometió a tratamiento psiquiátrico por mucho tiempo. Felipe y Zulma quedaron con trastornos severos y nunca pudieron contar lo que vivieron esa noche. Los únicos lúcidos y conscientes de ese grupo, Sebastián y Carlos, tampoco fueron los mismos. La pena y el espanto se habían clavado en sus corazones para siempre.
										</p>
								      </div>
								      <div class="modal-footer">
								        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
	...
	<!-- VI -->
	  <div class="card">
	    <img class="card-img-top" src="http://hugomitoire.com/wp-content/uploads/2018/08/Terror-6.jpg" alt="Card image cap">
	    <div class="card-body">
			<nav class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
			  <!-- Button trigger modal -->
			  <a class="btn btn-warning" data-toggle="collapse" href="#collapse6Terror" role="button" aria-expanded="false" aria-controls="collapse6Terror">Índice</a>

				<div class="collapse" id="collapse6Terror">
				  <div class="card card-body">
				    <ul>
				    	<li>
				    		<p>Catalepsia</p>
				    	...
				    	<li>
				    		<p>
								<!-- Button trigger modal -->
				    			<a data-toggle="modal" data-target="#nidoModal" href="#">
					    			El nido de la ñacanina 
					    			<small id="leer">
					    		      <i class="fab fa-readme"></i>
					    		    </small>
				    			</a>
								...
								<!-- Modal -->
								<div class="modal fade bd-example-modal-lg" id="nidoModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
								  <div class="modal-dialog modal-dialog-centered" role="document">
								    <div class="modal-content">
								      <div class="modal-header">
								      ...
								      <div class="modal-body container belle h4">
										<p>
											¿Alguien vio alguna vez un nido de ñacaniná…? ¿Con ñacaniná y todo? 
										</p>
										<p>
											¿No? No saben lo que se pierden.
										</p>
										<p>
											Ver un nido en vivo y en directo es uno de los instantes más estremecedores que puede tener una persona, un instante de miedo al cien por ciento. Pánico en su máximo nivel. ¡Qué momento tan maravilloso!
										</p>
										<p>
											No hay película, televisión, computadora ni jueguito electrónico que pueda llegarle a los talones o brindarnos un espectáculo igual.
										</p>
										<p>
											Obvio, no es lo mismo ver a una víbora por televisión que verla a cinco metros de distancia ¡y sabiendo que te correrá! ¡Pura adrenalina!
										</p>
										<p>
											Les cuento cómo es la cosa. La ñacaniná es una víbora no venenosa (a pesar de que por ahí leerán que es venenosa, el tío Aldo me aseguró que no es venenosa y Sanseacabó). Suele medir hasta dos metros, y su hábitat natural son los esteros y cañadas. Come ranitas, ratitas de pajonales, bichitos en general, gallinas, pollitos y huevos. Es básicamente una víbora constrictora, o sea, se te enrosca y te ahoga como si fueras un cachilito. Pero además, tiene otra característica terrible: ¡corre como un cohete! ¡Qué lo tiró! 
										</p>
										<p>
											Es una de las víboras más veloces, tanto por tierra ¡como en el agua! ¡Hay que ver cómo corre la desgraciada! Y tiene una particularidad que la hace más aterradora aún, y es que cuando navega, saca su cabeza y parte de su cuerpo fuera del agua ¡como el periscopio de un submarino! ¡Imagínense entonces corriendo en la cañada con algo así detrás de sus talones!
										</p>
										<p>
											Yo sabía esto desde chiquito, porque me lo contaban mi tío y mi primo Sergio. En el campo era raro encontrar un chico al que no lo hubiera corrido alguna vez una ñacaniná. ¡A Sergio lo habían corrido más de diez veces! Al final ese asunto terminó transformándose en una especie de deporte: “Huyendo de la ñacaniná” podríamos ponerle de título.
										</p>
										<p>
											Mi primo tenía muchos amigos ahí en Cancha Larga, todos por supuesto, chicos del campo como él. Había dos que eran sus íntimos: los hermanos Eduardo y Raúl Acuña. Los tres ya habían sido alcanzados y mordidos por esta aterradora viborita, y Eduardo era el que tenía el récord: ya lo habían mordido tres veces. La verdad es que me hacían sentir inferior cuando contaban esas cosas, sobre todo porque yo veía una lagartija y salía corriendo.
										</p>
										<p>
											Cuando tenía siete u ocho años, me daba miedo y ni por las tapas quería ir a ver un nido de ñacaniná o cosas parecidas. Pero después de que cumplí los diez, ya era grandecito como para andar achicándome ante cualquier peligro y a pesar de que me moría de miedo, ¡minga que me iba a achicar! Aparte, no quería hacerle pasar vergüenza a Sergio y que le dijeran que tenía un primo pueblerino y miedoso. Por supuesto, era pueblerino y miedoso ¡pero cómo lo disimulaba!
										</p>
										<p>
											Recuerdo la primera vez que fuimos a ver un nido. No sólo era verlo de cerca, sino que había que cascotearlo y embravecer a la víbora ¡y a correr se ha dicho! Ésa era la diversión. Ya me habían explicado para que no me hiciera problema si por ahí me alcanzaba y me daba un mordiscón, que eso no tenía importancia, y había que hacer de cuenta como si nos hubiese arañado un gato o picoteado un loro. Con eso me quedé algo más tranquilo ¡pero igual estaba dispuesto a correr con todas mis energías hasta echar los bofes!
										</p>
										<p>
											Hacia el fondo de la chacra del tío Luis, había una cañada no muy grande, justo al costado de la chacra de los Almanza. Tendría unos doscientos metros de largo por cien de ancho. Ahí había de todo. 
										</p>
										<p>
											La ñacaniná suele hacer su nido en algún montículo de tierra que sobresale del agua, pero siempre dentro de la cañada. Allí deposita sus huevos, y los cuida hasta que salen sus hijitos. Si hay una madre que cuida a su cría ¡sin dudas ésa es la ñacaniná! ¡Qué lo tiró que es brava la señora!
										</p>
										<p>
											La diversión consistía en acercarse de la manera más sigilosa posible desde distintos ángulos, cosa de rodearla por todas partes. Debíamos ir en alerta máxima, mirando fijamente el nido, donde se hallaba enroscada la víbora, y apenas la veíamos que se desenrollaba y comenzaba a sumergirse ¡patitas para qué las quiero y a correr se ha dicho! Porque eso significaba que ya nos había oído y se largaba al ataque. Por supuesto, era una lotería saber a quién correría de todos los que nos acercábamos.
										</p>
										<p>
											En esa oportunidad, tuvimos que caminar bastante —cañada adentro—, hasta divisar el nido. A unos cincuenta metros nos distribuimos los cuatro, cosa de rodearla desde todas partes. El agua nos llegaba casi hasta las rodillas. Yo pedí que me dejaran correr hacia la parte más playa, porque era el más nuevo e inexperto. Me autorizaron por esa vez.
										</p>
										<p>
											Todos llevábamos cascotes, para el caso de que la víbora estuviera muy perezosa. Y efectivamente estaba perezosa. Llegamos hasta unos ocho o diez metros, y la vimos ¡era inmensa! Estaba toda enroscada sobre el montículo de tierra. Nosotros, en silencio absoluto. Nos hicimos señas y preparamos una andanada de cascotazos. “¡Ya!”, gritó Sergio, y todos lanzamos nuestros cascotes.
										</p>
										<p>
											En un santiamén la víbora se desenrolló al tiempo que velozmente se sumergía, y vimos los movimientos de los pastitos y camalotes, por donde iba nadando subacuáticamente ¿y a qué no saben hacia quién se dirigía? ¡¡Sí!! ¡Acertaron! ¡La desgraciada se venía derechito hacia mí! ¡¡Cómo nadaba la loca!! Por supuesto que yo salí como alma que se la lleva el Diablo, y mientras corría, los otros se mataban de risa y me gritaban guarangadas y otras cosas, pero yo sólo miraba el camino y los obstáculos que tenía por adelante ¡miren si me caía! Ahí sí que me agarraba la ñacaniná, me enroscaba y me mordisqueaba todo. Como no miraba para atrás, sólo me guiaba por los gritos de los chicos, y según ellos, parecía que ya estaba a punto de  alcanzarme.
										</p>
										<p>
											Habré corrido unos doscientos metros, chapoteando o atropellando cardos y pajonales, y tal vez la víbora sólo me habrá perseguido unos veinte o treinta metros nomás, o sea que corrí más de ciento cincuenta metros al santo cohete ¡pero qué me importaba! Yo sólo quería asegurarme.
										</p>
										<p>
											Creo que luego de esa experiencia, ya estaba en condiciones de representar a mi país en los juegos olímpicos mundiales. Me sentía el niño más veloz del planeta.
										</p>
										<p>
											Pero como todo juego peligroso —y éste de verdad que era muy peligroso— a veces, en vez de gracioso y divertido suele resultar trágico y aterrador. 
										</p>
										<p>
											Todos en Cancha Larga recuerdan el caso de los hermanitos Ávalos, una familia requetepobre y humilde. Eran tan pobres que tres de sus hijos habían muerto de desnutrición. Ninguno fue a la escuela, porque les quedaba lejísimo. Y con el hambre y la debilidad que tenían sumados a la pobreza, eso era una imposibilidad absoluta. En total eran nueve, pero si les restamos los tres muertos, sólo nos quedan seis. Bueno, de estos seis es que quiero contarles la historia.
										</p>
										<p>
											Cuando ocurrió el hecho, el más grandecito tendría once años y el más chiquito era un bebé de dos meses. Vivían en un lugar muy inhóspito y casi inaccesible, donde sólo se podía llegar a pie o a caballo, atravesando montes, picadas y esteros. Yo recuerdo que desde la panadería del tío Aldo, uno podía llegar hasta ese ranchito si se internaba por una picada muy angosta entre pajonales y montes. La distancia sería de media legua más o menos.
										</p>
										<p>
											El ranchito estaba ubicado a orillas del monte y a unos veinte metros comenzaba un gran estero. Se imaginarán que estos chicos no tenían otro lugar para estar, para jugar o para recorrer que los alrededores de su casa. El humilde padre, todos los días salía a recorrer las chacras de la zona en busca de trabajo o para pedir algo de comida a alguien piadoso. La mayoría de las veces no conseguía ninguna changa, ni tampoco comida. No había ningún lugar cercano para pescar; y para cazar, no tenía siquiera una escopeta, apenas una honda y un machete, con los que conseguía cada tanto matar algunas palomas o charatas, o cazar un tatú. Lo más frecuente solía ser atrapar algunas aves con las dos o tres cimbras que tenía preparadas en el monte.
										</p>
										<p>
											En esas condiciones, los chicos estaban cada vez más débiles y flaquitos. La pobre madre, desesperada, no sabía qué hacer durante el día ante sus hambrientos hijitos. Para colmo, su bebé, de apenas dos meses, era puro piel y huesos. De tan desnutrido, tal vez no llegaba a pasar ni dos kilos. Casi ni lloraba de lo débil que estaba. 
										</p>
										<p>
											Angustiada, la madre decidió ponerse a buscar un trabajo como empleada doméstica en alguna chacra. Y lo consiguió. Desde ese día, partía a las cuatro de las madrugada cada mañana para estar a las seis en la chacra de los Alviso. Hacia el atardecer, ya estaba de regreso. El padre continuaba con su diario trajinar por toda la zona buscando alguna changuita o comida.
										</p>
										<p>
											Claro, desde el día en que la madre comenzó a salir a trabajar los chicos quedaban solos. El mayor debía hacerse cargo del cuidado de sus hermanitos.
										</p>
										<p>
											A los pocos días ocurrió la desgracia.
										</p>
										<p>
											A eso de las diez de la mañana, tres de los hermanos —el de diez, el de nueve y el de ocho— salieron hacia el estero a buscar, como todos los días, nidos de teros y de perdices. La mamá solía hacer tortillas con los huevos de estas aves. El mayor, con el bebé, y una hermanita de dos años fueron hasta un algarrobo a orillas del estero. Al bebé lo tenían en una especie de cunita hecha con un cajón de manzanas. Se sentaron bajo la sombra del gran árbol entre los pajonales, y ahí estaban, hasta que de pronto, el hermano mayor ve una bandada de palomas que se posaban en un mogote cercano, a unos cien metros. Le dijo a su hermanita que se quedara quieta y calladita cuidando al bebé, hasta que él regresara. Preparó su honda y unos cuantos balines, y sigilosamente se dirigió hacia el mogote. Con un poco de suerte podría matar una y así tendrían algo para comer. 
										</p>
										<p>
											Al mismo tiempo, los tres hermanos que andaban por el estero encontraron un nido de ñacaniná, y como siempre solía ocurrir, no aguantaron la tentación de cascotearlo y salir a correr. La víbora enfurecida comenzó a perseguir a los niños, que pasaron corriendo cerca del algarrobo —hacia el ranchito— sin ver ni advertir que su hermanita y el bebé estaban allí.
										</p>
										<p>
											La nena de dos años, que distraídamente jugaba con unos palitos al lado de la cuna-cajón, de pronto vio asomar entre los pajonales a esa tremenda víbora de casi dos metros, que se acercaba hacia ella con su amenazante cabeza erguida. Muda de espanto, sin siquiera poder llorar, salió a correr hacia el ranchito. Al llegar allí, lloraba con la respiración entrecortada sin poder decir una palabra, mientras los tres hermanos trataban de consolarla, diciéndole que no tuviera miedo, que la víbora no llegaría hasta el ranchito. Entre sollozos ahogados y entrecortados, la nena sólo atinaba a señalar con insistencia hacia el algarrobo, queriendo hacer entender que allí… había quedado el bebé. Los hermanitos pensaban simplemente que había visto a la ñacaniná cerca del algarrobo y que por eso estaba tan asustada.
										</p>
										<p>
											Algunos minutos después, cuando el mayor volvía hacia el algarrobo desplumando a la paloma que había cazado, se encontró con la espantosa y macabra situación que lo dejó paralizado de horror: dentro del cajón, estaba la feroz ñacanina… enrollada como un ovillo sobre el cuerpito y sabanitas del bebé.
										</p>
								      </div>
								      <div class="modal-footer">
								        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
...
<section id="libros-list" class="card-columns p-1">
	...
	<!-- CRISPÍN SOTO -->
	  <div class="card">
	    <img class="card-img-top" src="http://hugomitoire.com/wp-content/uploads/2018/08/Crispín-Soto.jpg" alt="Card image cap">
	    <div class="card-body">
			<nav class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
			  <!-- Button trigger modal -->
			  <a class="btn btn-warning disabled" data-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">Índice</a>
	...
	<!-- CRIATURAS CELESTES -->
	  <div class="card">
	    <img class="card-img-top" src="http://hugomitoire.com/wp-content/uploads/2018/08/Criaturas-celestes.jpg" alt="Card image cap">
	    <div class="card-body">
			<nav class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
			  <!-- Button trigger modal -->
			  <a class="btn btn-warning disabled" data-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">Índice</a>
...
<section id="libros-list" class="card-columns p-1">
	...
	<!-- MARIEL -->
	  <div class="card">
	    <img class="card-img-top" src="http://hugomitoire.com/wp-content/uploads/2018/08/Mariel.jpg" alt="Card image cap">
	    <div class="card-body">
			<nav class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
			  <!-- Button trigger modal -->
			  <a class="btn btn-warning disabled" data-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">Índice</a>
